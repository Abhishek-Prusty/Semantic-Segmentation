...
def FCN8( nClasses ,  input_height=input_height, input_width=input_width):
    ...
    # cl10= Conv2DTranspose( 1 , kernel_size=(8,8) ,  strides=(8,8) , use_bias=False, data_format=IMAGE_ORDERING )(o)
    # o10 = (Activation('softmax'))(cl10)
    
    
    #model = Model(img_input, [o1,o2,o3,o4,o5,o6,o7,o8,o9,o10])
...
model.load_weights('modelFCN8_bhoomi_3.h5')
